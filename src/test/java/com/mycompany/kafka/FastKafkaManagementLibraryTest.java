...
/**
 * Fast test class that focuses on testing the error handling system
 * without requiring actual Kafka connections and runs in under 2 seconds.
 */
public class FastKafkaManagementLibraryTest {
