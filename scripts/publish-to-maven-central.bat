...
echo 4. Find your repository (iogithubarvinubhi-XXXX)
...
echo https://repo1.maven.org/maven2/io/github/arvinubhi/kafka-management-library/
echo.
echo Users can then add your library to their pom.xml:
echo ^<dependency^>
echo     ^<groupId^>io.github.arvinubhi^</groupId^>
